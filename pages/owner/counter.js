    ...
    try {
      const orderData = {
        ...
        items: cart.map(item => ({
          ...
          hsn: item.hsn, tax_rate: item.tax_rate, is_packaged_good: item.is_packaged_good
        }))
      }
      ...
      setCart([]); setCustomerName(''); setCustomerPhone(''); setPaymentMethod('cash'); setDrawerOpen(false)
    } catch (error) {
    ...
    <div style={{ minHeight: '100vh', background: '#f8f9fa', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
          ...
          {/* Desktop cart badge hidden on mobile; mobile has bottom bar */}
      ...
      <div className="main-wrap" style={{ display: 'grid', flex: 1, background: 'transparent' }}>
        ...
        <div style={{ overflow: 'auto' }}>
          ...
          {/* Menu grid */}
          <div style={{ padding: '0 1rem 6rem' /* keep space for mobile cart bar */ }}>
                    ...
                    return (
                      <div key={item.id} style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 12, opacity: isAvailable ? 1 : 0.6 }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 8 }}>
                          <span>{item.veg ? '🟢' : '🔺'}</span>
                          <div style={{ flex: 1 }}>
                            <h3 style={{ margin: '0 0 4px 0', fontSize: 14, fontWeight: 600 }}>{item.name}</h3>
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .desk-cart { display: none; }      /* hide fixed sidebar */
          .desk-only { display: none; }      /* hide desktop badge */
          .mob-cartbar {
        ...
        .drawer {
          width: 100%; max-width: 720px; height: 80vh; background: #fff;

...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (title!= null && body!= null && orderId!= null) {
                // Manually build and display the notification with the corrected logic.
    ...
    private void sendNotification(String title, String body, String orderId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // This is the critical fix: the sound is now correctly set on the channel itself.
        ...
        // For older Android versions, we set the sound on the builder directly.
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
